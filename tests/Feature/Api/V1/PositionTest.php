...
class PositionTest extends TestCase
{
    ...
    public function test_can_filter_positions_by_avg_price_range()
    {
        ...
        Position::factory()->create(['user_id' => $this->user->id, 'asset_id' => $asset1->id, 'avg_price' => '5.00']);
        Position::factory()->create(['user_id' => $this->user->id, 'asset_id' => $asset2->id, 'avg_price' => '15.00']);
        Position::factory()->create(['user_id' => $this->user->id, 'asset_id' => $asset3->id, 'avg_price' => '25.00']);
        ...
        $response->assertStatus(Response::HTTP_OK)
            ->assertJsonCount(1, 'data')
            ->assertJsonPath('data.0.avg_price', '15.00');
    }
}
